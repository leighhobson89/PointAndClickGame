...
export function gameLoop() {
    ...
    if (getDisplayText().value1) {
        drawTextOnCanvas(getDisplayText().value1, getDisplayText().value2, getCurrentXposNpc(), getCurrentYposNpc());
    }
