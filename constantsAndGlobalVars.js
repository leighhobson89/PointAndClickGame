...
export const INITIAL_GAME_ID_NORMAL = 'cowPath';
export const INITIAL_GAME_ID_DEBUG = 'debugRoom';
export const INITIAL_GAME_BACKGROUND_URL_NORMAL = './resources/backgrounds/cowPathBrokenFence.png';
...
export const INITIAL_PLAYER_GRID_REF = {x: 20, y: 57}; //player start location on initial screen //10, 57
...
export const TEXT_DISPLAY_DURATION = 900; //3500
