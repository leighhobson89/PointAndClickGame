...
- [x] **Approve the painted player package.** Leigh accepted the 40-frame package and revised motion on 2026-09-19; no further human paint-over is required. BUG-039 is resolved.
- [x] **Complete the Library Foyer room package.** The accepted 832 x 448 repaint, aligned foreground, four fitted door states, original chair cut-outs, open-state offsets, book/key placement, walkable-area package, responsive resize alignment, and load-time open-door rebuild are wired and browser-tested.
- [x] **Settle the production decisions.** River Crossing is the exterior gold standard, Kitchen the interior gold standard, and off-aspect rooms are recomposed at 832 x 448 during each restyle rather than stretched.
- [x] **Complete Leigh's manual Chapter 1 review** of narrative continuity, humour, pacing, discoverability, puzzle fairness, and the bridge into later chapters.
