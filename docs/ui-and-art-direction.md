...
The Section 7 UI and accessibility direction is implemented and recorded in [archive/ui-and-art-direction-completed.md](archive/ui-and-art-direction-completed.md). This live document now carries only the art direction and asset work that remains.
